...
def run_greedy_selection(mode="robust", target_sizes=[1, 3, 6]):
    ...
    for size in range(1, max(target_sizes) + 1):
        ...
        for candidate in remaining_candidates:
            ...
            main.train(exp_name=exp_name, leads=trial_leads, max_epochs=5, batch_size=32)
            
            # 2. Test on Clean ECGs
            clean_results = main.test(exp_name=exp_name, leads=trial_leads, corruption=None)
            ...
            if mode == "clean":
                ...
                # Experiment 4 Selection Criterion: Accuracy - Instability Penalty
                instability_penalties = []
                for corr in CORRUPTIONS:
                    corr_results = main.test(exp_name=exp_name, leads=trial_leads, corruption=corr)
            ...
            if score > best_score:
                ...
                best_candidate_metrics = {
                    ...
                    "clean_auprc": clean_results["auprc"],
                    "penalty": penalty,
                    "robust_score": score
                }
        ...
        if size in target_sizes:
            summary_history.append({
                ...
                "Clean AUPRC": best_candidate_metrics["clean_auprc"],
...
if __name__ == "__main__":
    ...
    # print("\n EXPERIMENT 4 SUMMARY (ROBUST SELECTION):")
