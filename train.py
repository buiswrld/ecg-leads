...
# This folder contains the preprocessed .csv and the .npy array
...
class ECGClassificationTask(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # * Get ECGs and labels from the batch.
...
def build_dataloaders(params):
    ...
    # * Return the dataloaders and anything else needed later.
...
def get_num_leads(params):
    ...
    # * Return 12 if using all leads. Otherwise, return the number of selected leads.
